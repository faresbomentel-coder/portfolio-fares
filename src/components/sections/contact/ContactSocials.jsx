...
function ContactSocials() {
  return (
    <Card>
      <h3 className="text-xl font-bold text-slate-900 dark:text-slate-100 mb-4">Réseaux Sociaux</h3>
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-slate-900 dark:text-slate-100 font-semibold">{social.name}</p>
                <p className="text-slate-600 dark:text-slate-300 text-sm truncate">
                  {social.username}
                </p>
              </div>
              <svg
                className="w-5 h-5 text-slate-400 dark:text-slate-500 group-hover:text-blue-600 dark:group-hover:text-cyan-400 group-hover:translate-x-1 transition-all"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
